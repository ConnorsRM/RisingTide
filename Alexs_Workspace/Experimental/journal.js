...
Journal.prototype.displayEntry = function (entryNum) {
    if (entryNum == 1) {
        Journal.prototype.entry1();
    }
    if (entryNum == 2) {
        Journal.prototype.entry2();
    }
    if (entryNum == 3) {
        Journal.prototype.entry3();
    }
    if (entryNum == 4) {
        Journal.prototype.entry4();
    }
    if (entryNum == 5) {
        Journal.prototype.entry5();
    }
    if (entryNum == 6) {
        Journal.prototype.entry6();
    }
    if (entryNum == 7) {
        Journal.prototype.entry7();
    }
    if (entryNum == 8) {
        Journal.prototype.entry8();
    }
    if (entryNum == 9) {
        Journal.prototype.entry9();
    }
    if (entryNum == 10) {
        Journal.prototype.entry10();
    }
    if (entryNum == 11) {
        Journal.prototype.entry11();
    }
    if (entryNum == 12) {
        Journal.prototype.entry12();
    }
    if (entryNum == 13) {
        Journal.prototype.entry13();
    }
    if (entryNum == 14) {
        Journal.prototype.entry14();
    }
    if (entryNum == 15) {
        Journal.prototype.entry15();
    }
    if (entryNum == 16) {
        Journal.prototype.entry16();
    }
    if (entryNum == 17) {
        Journal.prototype.entry17();
    }
    if (entryNum == 18) {
        Journal.prototype.entry18();
    }
}
